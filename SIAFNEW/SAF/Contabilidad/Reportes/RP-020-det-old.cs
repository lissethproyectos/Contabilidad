...
namespace SAF.Contabilidad.Reportes {
    ...
    public class RP_020_det_old : ReportClass {
        
        public RP_020_det_old() {
        }
        
        public override string ResourceName {
            get {
                return "RP-020-det-old.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Contabilidad.Reportes.RP-020-det-old.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_020_det_old : Component, ICachedReport {
        
        public CachedRP_020_det_old() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_020_det_old rpt = new RP_020_det_old();
            rpt.Site = this.Site;
            return rpt;
        }
