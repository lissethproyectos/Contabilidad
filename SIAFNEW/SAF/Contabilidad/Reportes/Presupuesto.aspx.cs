...
namespace SAF.Contabilidad.Reportes
{
    public partial class Presupuesto : System.Web.UI.Page
    {
        ...
        {
            string ruta = "../Reportes/VisualizadorCrystal.aspx?Tipo=RP_Cedulas&Ejercicio=" + ddlEjercicio.SelectedValue + "&mes_inicial=" + ddlPInicial.SelectedValue + "&mes_final=" + ddlPFinal.SelectedValue;
        ...
        {
            string ruta = "../Reportes/VisualizadorCrystal.aspx?Tipo=RP_Cedulasxls&Ejercicio=" + ddlEjercicio.SelectedValue + "&mes_inicial=" + ddlPInicial.SelectedValue + "&mes_final=" + ddlPFinal.SelectedValue;
            string _open = "window.open('" + ruta + "', '_newtab');";
            //string _open = "window.open('" + ruta + "', 'miniContenedor', 'toolbar=yes', 'location=no', 'menubar=yes', 'resizable=yes');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), _open, true);
