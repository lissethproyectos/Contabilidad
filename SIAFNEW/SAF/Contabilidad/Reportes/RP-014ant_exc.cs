...
namespace SAF.Contabilidad.Reportes {
    ...
    public class RP_014ant_exc : ReportClass {
        
        public RP_014ant_exc() {
        }
        
        public override string ResourceName {
            get {
                return "RP-014ant_exc.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Contabilidad.Reportes.RP-014ant_exc.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_014ant_exc : Component, ICachedReport {
        
        public CachedRP_014ant_exc() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_014ant_exc rpt = new RP_014ant_exc();
            rpt.Site = this.Site;
            return rpt;
        }
