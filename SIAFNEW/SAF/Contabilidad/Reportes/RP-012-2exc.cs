...
namespace SAF.Contabilidad.Reportes {
    ...
    public class RP_012_2exc : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SAF.Contabilidad.Reportes.RP-012-2exc.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_012_2exc : Component, ICachedReport {
        
        public CachedRP_012_2exc() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_012_2exc rpt = new RP_012_2exc();
            rpt.Site = this.Site;
            return rpt;
        }
