...
namespace SAF.Contabilidad.Reportes {
    ...
    public class RP_014exc_old : ReportClass {
        
        public RP_014exc_old() {
        }
        
        public override string ResourceName {
            get {
                return "RP-014exc-old.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SAF.Contabilidad.Reportes.RP-014exc-old.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRP_014exc_old : Component, ICachedReport {
        
        public CachedRP_014exc_old() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_014exc_old rpt = new RP_014exc_old();
            rpt.Site = this.Site;
            return rpt;
        }
