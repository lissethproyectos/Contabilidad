...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-1"><asp:ImageButton ID="btnNuevo" runat="server" ImageUrl="https://sysweb.unach.mx/resources/imagenes/nuevo.png" OnClick="btnNuevo_Click" /></div>
        </div>
        <div class="row">
                    ...
                    <asp:View ID="View2" runat="server">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <ajaxToolkit:HtmlEditorExtender ID="txtobservacion_HtmlEditorExtender" runat="server" EnableSanitization="False" TargetControlID="txtobservacion">
    ...
    <script type="text/javascript">        
        function Mensajes() {
            $('#<%= grdinformativa.ClientID %>').prepend($("<thead></thead>").append($('#<%= grdinformativa.ClientID %>').find("tr:first"))).DataTable({
                "destroy": true,
                "stateSave": false,
                "ordering": false
            });
