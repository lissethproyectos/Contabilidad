    ...
    public partial class frmRegPolizas2 : System.Web.UI.Page
    {
        ...
        private string VerificaMes()
        {
            try
            {
                ...
                CNPoliza.ValidarMes(Convert.ToInt32(SesionUsu.Usu_Ejercicio), "CONTABILIDAD", DDLCentro_Contable.SelectedValue, ref MesCC, ref Verificador);
        ...
        protected void linkBttnVerPartidas_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ListPartidas.Count > 0)
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), UniqueID, "mostrar_modal(0, 'No se encontro cédula para recuperación de partidas, favor de verificar.');", true);
