<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMonitorPatrimonio-2.aspx.cs" Inherits="SAF.Patrimonio.Form.frmMonitorPatrimonio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="mensaje"> 
       <asp:UpdatePanel ID="updPnl3" runat="server">
                    <ContentTemplate>
    ...
    <table class="tabla_contenido">       
        ...
        <tr>
            <td align="center">
                <asp:UpdateProgress ID="updProg1" runat="server" AssociatedUpdatePanelID="updPnl1">
                    <ProgressTemplate>
